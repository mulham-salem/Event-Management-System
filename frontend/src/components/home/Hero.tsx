        ...
        >
            ...
            <div className="relative z-10 mx-auto w-full max-w-7xl px-6">
                ...
                >
                    <h1 className="font-nata-sans-bd text-5xl leading-snug drop-shadow-xl md:text-7xl">
                        Elevate your event<br/>experience with us
                    </h1>

                    <p className="mt-6 font-nata-sans-rg text-xl text-gray-200 drop-shadow">
                        Connect, learn, and collaborate with leaders, innovators, and creators
                        from around the world - all gathered in one unforgettable conference.
                    </p>
                </motion.div>
            </div>
            ...
            >
                <div className="relative h-[480px] w-[420px] md:h-[580px] md:w-[520px]">
                    ...
                    {/* الصورة الأولى */}
                    <div className="absolute left-0 top-0 h-56 w-72 rotate-[-4deg] overflow-hidden
                    ...
                    <div className="absolute bottom-0 right-0 h-56 w-72 rotate-[4deg] overflow-hidden
                        rounded-2xl shadow-2xl md:h-72 md:w-96">
                        <img
...
//bg-gradient-to-br from-[#dfe9ff] via-[#e9d7ff] to-[#c8f0ff]
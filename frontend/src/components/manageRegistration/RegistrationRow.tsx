        ...
        >
            ...
            <td className="w-full px-6 py-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Registration request</p>
                </div>
            </td>
            ...
            <td className="px-6 py-4">
                <div className="flex items-center gap-3">
                    <div
                        className="flex h-9 w-9 items-center justify-center rounded-full bg-amber-100 text-sm font-semibold text-amber-700">
                        {getInitials(registration.attendee.full_name)}
                    </div>

                    <div>
                        <p className="font-nata-sans-md text-slate-800">
            ...
            <td className="px-6 py-4 text-center">
                <span className="
                  ...
                  font-nata-sans-md text-xs text-slate-700
                ">
